...
class BacktestEngine:
    ...
    """
    def __init__(self, candles: List[Candle], strategy_name: str = "fake_trend", speed: float = 100.0):
        ...
        self.price_feed = self.market.price_feed  # shared feed
    ...
    def _build_strategy(self, name: str):
        if name == "fake_random":
            return FakeStrategyRandom(self.event_bus)
    ...
    def _on_price(self, event):
        ...
        self.equity_curve.append({"price": self._last_price})
